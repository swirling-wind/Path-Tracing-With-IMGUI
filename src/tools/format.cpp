...
std::string Format::time_duration(const size_t millisecond_duration)
{
...
std::string Format::large_number(size_t n)
{
...
std::string Format::progress(const double progress)
{
